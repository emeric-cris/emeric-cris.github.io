 ...
 $(document).on('scroll', function() {
     if ($(document).scrollTop() >= $('#section_header').offset().top - 400 && $(document).scrollTop() < $('#section_historia').offset().top) {
     ...
     if ($(document).scrollTop() >= $('#section_invitación').offset().top - 500 && $(document).scrollTop() < $('#section_invitación').offset().top) {
